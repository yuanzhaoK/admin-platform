...
export default async function(params: Params, context: Context) {
  ...
  const updateFunctionName = (name: string) => {
    if (!currentFunction) return;
    const updatedFunction = { ...currentFunction, name };
    setCurrentFunction(updatedFunction);
    setFunctions(prev => prev.map(f => f.id === currentFunction.id ? updatedFunction : f));
  };
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div>
                        <Label>Runtime</Label>
                        <div className="text-sm text-gray-600 mt-1">Node.js 18</div>
                      </div>
                      <div>
                        <Label>Timeout</Label>
                        <div className="text-sm text-gray-600 mt-1">30 seconds</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
