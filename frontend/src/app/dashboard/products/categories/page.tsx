...
export default function ProductCategoriesPage() {
  ...
  // GraphQL 查询
  const { data: categoriesData, loading, error, refetch } = useQuery(
    GET_PRODUCT_CATEGORIES,
    {
      variables: {
        query: {
  ...
  const categoryTree =
    categoryTreeData?.categoryTree?.map((item: any) => item.category) || [];
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updateFormData("parent_id", value === "none" ? "" : value)}
                >
                  <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updateFormData("seo_description", e.target.value)}
                placeholder="SEO描述"
                rows={2}
              />
            </div>
